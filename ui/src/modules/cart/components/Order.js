  ...
  const products = [
    {
      ...
      desc: "หูฟัง อุ๋งอุ๋ง ของแท้ พร้อมแผงควบคุมอัจฉริยะ และ รองรับ สมาร์ทโฟนทุกรุ่นในจักรวาล เสียงใส เบสแบบจัดเต็ม",
      image:
    ...
    },
    {
      ...
      desc: "ต้องการนาฬิกาก็อปปี้เกรดดีใช่ไหม ต้องรุ่นนี้เลย ซื้อไปรับรองพังในสามนาที",
      image:
